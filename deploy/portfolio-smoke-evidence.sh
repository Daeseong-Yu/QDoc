...
PUBLIC_RELEASE_PREFLIGHT="$(status_value QDOC_SMOKE_PUBLIC_RELEASE_PREFLIGHT)"
PUBLIC_BROWSER_SMOKE="$(status_value QDOC_SMOKE_PUBLIC_BROWSER_SMOKE)"
...
P5B_STATUS="$(package_status "$PUBLIC_RELEASE_PREFLIGHT" "$PUBLIC_BROWSER_SMOKE" "$P5B_PROVIDER_RESTRICTIONS" "$P5B_MAP_GEO_CENTER" "$P5B_MAP_PAN_ZOOM" "$P5B_MAP_RECENTER" "$P5B_MARKER_SYNC" "$P5B_MARKER_DISTINCTION" "$P5B_FAIL_CLOSED")"
P5C_STATUS="$(package_status "$P5C_PATIENT_OTP_DELIVERY" "$P5C_STAFF_OTP_DELIVERY" "$P5C_AUTH_ERROR_COPY" "$P5C_SESSION_REVISIT")"
P5D_STATUS="$(package_status "$PUBLIC_RELEASE_PREFLIGHT" "$PUBLIC_BROWSER_SMOKE" "$P5D_PATIENT_CHECKIN" "$P5D_PATIENT_STATUS_REVISIT" "$P5D_STAFF_QUEUE_OPS" "$P5D_STAFF_QUEUE_CONTROLS" "$P5D_STAFF_ROLE_BOUNDARY" "$P5D_MEMBERSHIP_AUDIT" "$P5D_AUDIT_LOG_REVIEW" "$P5D_NOTIFICATION_OUTBOX" "$P5D_WORKER_DUPLICATE_GUARD")"
...
log "Checking public release and browser smoke prerequisites"
validate_status "Public release preflight" "$PUBLIC_RELEASE_PREFLIGHT"
validate_status "Public browser smoke" "$PUBLIC_BROWSER_SMOKE"
...
Public smoke prerequisites:
  Public release preflight: $PUBLIC_RELEASE_PREFLIGHT
  Public browser smoke: $PUBLIC_BROWSER_SMOKE
