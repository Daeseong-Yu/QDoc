...
| P5-B Provider map public-browser | Geolocation-centered provider map, pan or native drag, zoom, recentering, marker/card sync, QDoc-vs-provider distinction, fail-closed states | Local zoom/recenter/selection proof exists; pan/drag proof plus staging/manual proof are pending | `<link-or-note>` |
